package com.sparta.notice.Security.filter;


import com.sparta.notice.jwt.HeaderTokenExtractor;
import com.sparta.notice.jwt.JwtPreProcessingToken;
...
public class JwtAuthFilter extends AbstractAuthenticationProcessingFilter {
    ...
    public JwtAuthFilter(String s, HeaderTokenExtractor extractor) {
        super(s);
        this.extractor = extractor;
    }
